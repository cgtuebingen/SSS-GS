...
renderSurfaceXYZCUDA(
    ...
    const float* __restrict__ depths,
    float* __restrict__ pseudo_normals,
    ...
    const float* __restrict__ surface_xyz)
{
    ...
    float norm = sqrtf(pseudo_normal[0]*pseudo_normal[0]+pseudo_normal[1]*pseudo_normal[1]+pseudo_normal[2]*pseudo_normal[2]);
    if (norm <= 0.00000f){
        return;
    }

    pseudo_normal[0] = -pseudo_normal[0] / norm;
    pseudo_normal[1] = -pseudo_normal[1] / norm;
    pseudo_normal[2] = -pseudo_normal[2] / norm;

    pseudo_normals[pix_id11] = viewmatrix[0] * pseudo_normal[0] + viewmatrix[1] * pseudo_normal[1] + viewmatrix[2] * pseudo_normal[2];
    pseudo_normals[HW + pix_id11] = viewmatrix[4] * pseudo_normal[0] + viewmatrix[5] * pseudo_normal[1] + viewmatrix[6] * pseudo_normal[2];
    pseudo_normals[2 * HW + pix_id11] = viewmatrix[8] * pseudo_normal[0] + viewmatrix[9] * pseudo_normal[1] + viewmatrix[10] * pseudo_normal[2];
}
