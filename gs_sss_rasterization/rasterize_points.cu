	...
	const bool debug)
{
  ...
  return std::make_tuple(rendered, n_contrib, out_color, out_opacity, out_depth, out_feature, out_pseudo_normal, out_surface_xyz, radii, geomBuffer, binningBuffer, imgBuffer);
}
